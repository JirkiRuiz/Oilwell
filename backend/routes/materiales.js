...
api.put('/actualizar_materiales_admin/',auth.auth, materialesController.actualizar_materiales_admin); 
api.delete('/eliminar_materiales_admin/',auth.auth, materialesController.eliminar_materiales_admin);  
